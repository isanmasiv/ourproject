            ...
            <div class="col span_5">
                <div class="floatleft">
                    <ul class="inline-ul no-margin">
                        ...
                        <li><p class="mail-top nova-text">&nbsp;&nbsp;&nbsp;&nbsp;deyurapb@gmail.com</p></li>
                    </ul>          
                </div>
            </div>
        ...
        <div class="container clr">
            <div class="row span_12 no-margin-col">
                ...
                <div class="col span_6">
                    <h2>Welcome to <a href="http://phpindonesia.com" target="_blank"><span class="text-bold">phpindonesia</span></a></h2>                    
                </div>
...
<section class="container clr">
    <div class="row">
        ...
        <div class="col span_4">
			...
			<form   method='post' action='<?php echo base_url(); ?>./index.php/cari/posting'>
<input  class="widget widget_search" type="text" name="cariposting" placeholder="Search here..."  >&nbsp;<input type="submit" name="submit" value="Cari">
</form>
...
<footer class="footer-container">
    <div class="container">
        <div class="widget-area row">
            ...
            <div class="col span_3">
				...
				<param name="flashvars" value="username=lupanamaasli"></param>
  ...
  js.src = "//connect.facebook.net/id_ID/sdk.js#xfbml=1&version=v2.5&appId=184337451632453";
  fjs.parentNode.insertBefore(js, fjs);
    ...
    <div class="copyright-container">
        <div class="container">
            <p class="white-text">© Copyright Absolution by<a target="blank" href="http://phpindonesia.com" class="green-hover"> Muhammad Rafiqi Liputo </a>- 2016</p>
        </div>
    </div>

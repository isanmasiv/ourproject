<html><head>
                ...
                <div class="popup">
                  ...
                  <div class="row-fluid">
                    ...
                    <div class="row-form">
                      ...
                      <div class="span8">
                        <input type="radio" class="cNav" name="cNavButton" value="default">Default
                        <input type="radio" class="cNav" name="cNavButton" value="bordered">Bordered</div>
                    </div>
                    <div class="row-form">
                      <div class="span4">Content:</div>
                      <div class="span8">
                        <input type="radio" class="cCont" name="cContent" value="">Responsive
                        <input type="radio" class="cCont" name="cContent" value="fixed">Fixed</div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="block">
                  <div class="data-fluid">
                    <div class="row-form">
                      ...
                      <div class="span9">
                        <input type="text" class="validate[required]" name="judul_post" value="<?php echo $judul_content; ?>" placeholder="judul post">
                      </div>
                    </div>
                    <div class="row-form">
                    ...
                    <div class="row-form">
                      ...
                      <div class="span9">
                        <textarea placeholder="deskripsi untuk google" name="deskripsi"><?php echo $deskripsi; ?></textarea>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="data-fluid">
                    <div class="row-form">
                      ...
                      <div class="span9">
                        ...
                        <select name="status">
                          <?php foreach($arr_status as $r){ if(strtolower($r)==$status_content){
                          ?>
                          <option selected="selected" value="<?php echo strtolower($r); ?>">
                            <?php echo $r; ?>
                          </option>
                          <?php }else{ ?>
                          <option value="<?php echo strtolower($r); ?>">
                            <?php echo $r; ?>
                          </option>
                          <?php } } ?>
                        </select>
                    ...
                    <div class="row-form">
                      ...
                      <div class="span9">
                        <select name="labels[]" multiple="multiple" class="validate[required] select" style="width: 100%;">
                          <?php foreach($label as $l){ if(!in_array($l[ 'kode_label'],$label_post)){
                          ?>
                          <option value="<?php echo $l['kode_label'] ?>">
                            <?php echo $l[ 'judul_label'] ?>
                          </option>
                          <?php } else { ?>
                          <option selected="selected" value="<?php echo $l['kode_label'] ?>">
                            <?php echo $l[ 'judul_label'] ?>
                          </option>
                          <?php } } ?>
                        </select>
                    ...
                    <div class="toolbar bottom tar">
                      <div class="btn-group">
                        <button class="btn btn-primary" type="button" onclick="window.open('<?php echo base_url(); ?>index.php/webadmin/pratinjau','_blank')">Pratinjau
                          <span class="icon-zoom-in icon-white"></span>
                        </button>
              ...
              <div class="span12">
                <div class="block">
                  <div class="head orange">
                    ...
                    <ul class="buttons">
                      <li>
                        <a href="#" onclick="source('editor_ck'); return false;"><div class="icon"><span class="ico-info"></span></div></a>
                      </li>
                    </ul>
                  </div>
                  <div class="data-fluid">
    ...
    <form id="pratinjo" target="_blank" action="<?php echo base_url(); ?>index.php/webadmin/cetak"></form>
    <script>

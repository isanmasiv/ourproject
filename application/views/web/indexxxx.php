            ...
            <div class="col span_5">
                <div class="floatleft">
                    <ul class="inline-ul no-margin">
                        <li><p class="phone-top nova-text">&nbsp;&nbsp;(+62) 81368640151</p></li>
        ...
        <div class="col span_8">
            ...
            <article class="entry">
                ...
                <div class="entry-text">
                    <a href="<?php echo base_url(); ?>./artikel.php/tutorial-<?php echo strtolower(str_replace(' ','-',preg_replace("/[^a-zA-Z0-9\s]/", "", $c['judul_content']))).'-'.$c['kode_content']; ?>">

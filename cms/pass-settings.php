...
<html>
	...
	<head>
		<title>Blogger KW - Setting > Password Setting</title>
	...
	<body>
		...
		<h3>Pengaturan Kata Sandi</h3><hr>
		<div class="blog-setting-left">
			<h4>Ganti Kata Sandi</h4>
			
			<form action="#" method="post">
			<label>Nama Pengguna:</label><br>
			<input type="text" name="#" required="required" placeholder="Masukkan Nama Pengguna" />
			<br><br>
			<label>Kata Sandi Baru:</label><br>
			<input type="password" name="#" required="required" placeholder="Masukkan Kata Sandi Baru" />
			<br><br>
			<label>Kata Sandi Lama:</label><br>
			<input type="password" name="#" required="required" placeholder="Masukkan Kata Sandi Lama" />
			<br><br>
		...
		<div class="navigation-left">
			...
			<div class="navigation-content">
				...
				<a href="/ourproject/cms/pass-settings.php" style="background-color:rgba(0,0,0,0.1)">Setting Password <span class="fa fa-dot-circle-o" id="current-page" title="Setting dasar blog"></span></a>
				</div>
				</div>

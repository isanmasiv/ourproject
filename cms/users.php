	...
	<body>
		...
		<div class="page-blog-container">
			<div class="blog-status">
				<h3 class="blog-name-title"><a class="blog-link" href="#">Nama Blog</a> | Pengguna</h3>
			</div>
			<div class="blog-name">
		...
		<form action="#" method="post">
			<div class="user-recruits-right">
				<label class="user-recruits-label">Facebook (URL):</label><br>
				<input type="text" name="#" class="user-recruits-input" /><br><br>
				<label class="user-recruits-label">Twitter (URL):</label><br>
				<input type="text" name="#" class="user-recruits-input" /><br><br>
				<label class="user-recruits-label">Google+ (URL):</label><br>
				<input type="text" name="#" class="user-recruits-input" /><br><br>
			</div>
			
			<div class="user-recruits-left">
				<label class="user-recruits-label">Username:</label><br>
				<input type="text" name="#" class="user-recruits-input" /><br><br>
				<label class="user-recruits-label">Nama Pengguna:</label><br>
				<input type="text" name="#" class="user-recruits-input" /><br><br>
				<label class="user-recruits-label">Password:</label><br>
				<input type="text" name="#" class="user-recruits-input" /><br><br>
			</div>
			<button class="user-submit-button" type="submit" style="float:right; clear:both;">Simpan</button><br>
		</form>
		<br><hr>

		<h3 class="comment-page-content-title">Tabel User</h3>
		<form action="#" method="get" role="search">
			<input class="post-search" type="search" placeholder="Cari pengguna">
		</form>
		...
		<table class="comment-table" border="0">
			<tr class="comment-table-row-top">
				...
				<td class="comment-table-data">Nama Pengguna</td>
				<td class="comment-table-data">Facebook</td>
				<td class="comment-table-data">Twitter</td>
				<td class="comment-table-data">Google+</td>
			...
			<tr class="comment-table-row-body">
				...
				<td class="comment-table-data-body"><a href="#" class="comment-essential">#Pengguna#</a></td>
				<td class="comment-table-data-body"><a href="#" class="comment-essential">#Facebook#</a></td>
				<td class="comment-table-data-body"><a href="#" class="comment-essential">#Twitter#</a></td>
				<td class="comment-table-data-body"><a href="#" class="comment-essential">#Google+#</a></td>
				<td class="comment-table-data-body" style="text-align:right;"><a href="#" class="action-delete">Hapus</a></td>
			</tr>
		</table>
		...
		<div class="navigation-left">
			...
			<div class="navigation-content">
				...
				<a class="navigation-link" href="javascript:void(0)" style="background-color:rgba(0,0,0,0.1)"><span class="fa fa-user" id="nav-icon"></span>&nbsp;&nbsp; User</a>

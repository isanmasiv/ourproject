...
<html>
	...
	<head>
		<title>Blogger KW - Posts > All Posts</title>
	...
	<body>
		...
		<div class="page-blog-container">
			<div class="blog-status">
				<h3 class="blog-name-title"><a class="blog-link" href="#">Nama Blog</a> | Semua Post</h3>
			</div>
			<div class="blog-name">
		...
		<h3>Semua Post</h3><hr>
		<h3 class="comment-page-content-title">Tabel Post</h3>
		...
		<div class="navigation-left">
			...
			<div class="navigation-content">
				...
				<a href="javascript:void(0)" style="background-color:rgba(0,0,0,0.1)">Semua Post <span class="fa fa-dot-circle-o" id="current-page" title="Lihat post"></span></a>

...
<html>
	...
	<head>
		<title>Blogger KW - Setting > General Setting</title>
	...
	<body>
		...
		<h3>Pengaturan Dasar</h3><hr>
		
		<div class="blog-setting-right">
			<h4>Kontak</h4>
			<form action="#" method="post">
			<label>Informasi:</label><br>
			<textarea name="info" class="ckeditor"></textarea><br>
		...
		<div class="blog-setting-left">
			<h4>Blog</h4>
			<form action="#" method="post">
			<label>Judul Blog (Site):</label><br>
			<input type="text" name="blogtitle_general" required="required" placeholder="Masukkan Judul Blog" />
			<br><br>
			<label>Deskripsi:</label><br>
			<textarea rows="8" name="blogdescript_general" placeholder="Masukkan Deskripsi"></textarea>
			<br><br>
			<label>Batas Konten:</label><br>
			<input type="text" name="bloglimit_general" required="required" placeholder="Batas Konten" />
			<br><br>
			<label>Facebook (URL):</label><br>
			<input type="text" name="facebookrofile_general" placeholder="Alamat Profil Facebook" />
			<br><br>
			<label>FB Fans Page (URL):</label><br>
			<input type="text" name="facebookfp_general" placeholder="Alamat Fans Page Facebook" />
			<br><br>
			<label>Twitter (URL):</label><br>
			<input type="text" name="twitterprofile_general" placeholder="Alamat Profil Twitter" />
			<br><br>
			<label>Google+ (URL):</label><br>
			<input type="text" name="googleplusprofile_general" placeholder="Alamat Profil Google+" />
			<br><br>
			<label>E-Mail:</label><br>
			<input type="email" name="email" placeholder="Alamat E-Mail" /><br><br>
			<button type="submit">Simpan</button>
			</form>
		...
		<div class="navigation-left">
			...
			<div class="navigation-content">
				...
				<a href="/ourproject/cms/general-settings.php" style="background-color:rgba(0,0,0,0.1)">Setting Dasar <span class="fa fa-dot-circle-o" id="current-page" title="Setting dasar blog"></span></a>

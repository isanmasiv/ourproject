...
<html>
	...
	<head>
		<title>Blogger KW - Comment > List Comment</title>
	...
	<body>
		...
		<div class="page-blog-container">
			<div class="blog-status">
				<h3 class="blog-name-title"><a class="blog-link" href="#">Nama Blog</a> | Komentar</h3>
			</div>
			<div class="blog-name">
		...
		<h3>Komentar</h3><hr>
		<h3 class="comment-page-content-title">Tabel Komentar</h3>
		...
		<table class="comment-table" border="0">
			<tr class="comment-table-row-top">
				...
				<td class="comment-table-data">Judul Konten</td>
				<td class="comment-table-data">Pengirim</td>
				<td class="comment-table-data">Status</td>
				<td class="comment-table-data">Komentar</td>
			...
			<tr class="comment-table-row-body">
				...
				<td class="comment-table-data-body"><a href="#" class="comment-essential">#Pengirim#</a></td>
				<td class="comment-table-data-body"><label class="status-label-published">#Status#</label></td>
				<td class="comment-table-data-body">#Komentar#</td>
				<td class="comment-table-data-body" style="text-align:right;"><a href="#" class="action-reply">Balas</a> <a href="#" class="action-delete">Hapus</a></td>
			</tr>
		</table>
		...
		<div class="navigation-left">
			...
			<div class="navigation-content">
				...
				<a class="navigation-link" href="javascript:void(0)" onclick="commentClicked()" style="background-color:rgba(0,0,0,0.1)"><span class="fa fa-comment" id="nav-icon"></span>&nbsp;&nbsp; Comment <span class="fa fa-sort-desc" id="nav-dd"></span></a>
				<div class="dropdown-comment-content" id="comment-content">
				<a href="/ourproject/cms/comments.php" style="background-color:rgba(0,0,0,0.1)">List Comment <span class="fa fa-dot-circle-o" id="current-page" title="Setting dasar blog"></a>
				</div>
				</div>

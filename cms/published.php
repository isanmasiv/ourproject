...
<html>
	...
	<head>
		<title>Blogger KW - Post > Published</title>
	...
	<body>
		...
		<div class="page-blog-container">
			<div class="blog-status">
				<h3 class="blog-name-title"><a class="blog-link" href="#">Nama Blog</a> | Publikasi</h3>
			</div>
			<div class="blog-name">
		...
		<h3>Dipublikasikan</h3><hr>
		<h3 class="comment-page-content-title">Tabel Published</h3>
		...
		<table class="comment-table" border="0">
			...
			<tr class="comment-table-row-body">
				...
				<td class="comment-table-data-body" style="text-align:right;"><a href="#" class="action-edit">Edit</a> <a href="#" class="action-delete">Hapus</a></td>
			</tr>
		</table>
		...
		<div class="navigation-left">
			...
			<div class="navigation-content">
				...
				<a href="/ourproject/cms/published.php" style="background-color:rgba(0,0,0,0.1)">Diterbitkan <span class="fa fa-dot-circle-o" id="current-page" title="Post yang telah publish"></span></a>
